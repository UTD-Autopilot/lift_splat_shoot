...
from pidnet.tools.custom import load_pretrained, input_transform
...
class LiftSplatShoot(nn.Module):
    def __init__(self, grid_conf, data_aug_conf, outC, type):
        ...
        if type == "seg":
            ...
            self.camencode = CamEncodeSeg(self.D, self.camC, self.downsample)
        elif type == "default":
...
def compile_model(grid_conf, data_aug_conf, outC, type="default"):
    return LiftSplatShoot(grid_conf, data_aug_conf, outC, type)
